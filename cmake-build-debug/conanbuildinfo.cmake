...
set(CONAN_SYSTEM_LIBS_ZMQPP )
set(CONAN_FRAMEWORKS_ZMQPP )
set(CONAN_FRAMEWORKS_FOUND_ZMQPP "")  # Will be filled later
set(CONAN_DEFINES_ZMQPP )
set(CONAN_BUILD_MODULES_PATHS_ZMQPP )
# COMPILE_DEFINITIONS are equal to CONAN_DEFINES without -D, for targets
set(CONAN_COMPILE_DEFINITIONS_ZMQPP )

set(CONAN_C_FLAGS_ZMQPP "")
set(CONAN_CXX_FLAGS_ZMQPP "")
set(CONAN_SHARED_LINKER_FLAGS_ZMQPP "")
set(CONAN_EXE_LINKER_FLAGS_ZMQPP "")

# For modern cmake targets we use the list variables (separated with ;)
set(CONAN_C_FLAGS_ZMQPP_LIST "")
set(CONAN_CXX_FLAGS_ZMQPP_LIST "")
set(CONAN_SHARED_LINKER_FLAGS_ZMQPP_LIST "")
set(CONAN_EXE_LINKER_FLAGS_ZMQPP_LIST "")

# Apple Frameworks
conan_find_apple_frameworks(CONAN_FRAMEWORKS_FOUND_ZMQPP "${CONAN_FRAMEWORKS_ZMQPP}" "_ZMQPP" "")
# Append to aggregated values variable
set(CONAN_LIBS_ZMQPP ${CONAN_PKG_LIBS_ZMQPP} ${CONAN_SYSTEM_LIBS_ZMQPP} ${CONAN_FRAMEWORKS_FOUND_ZMQPP})
...
set(CONAN_DEFINES_LIBSODIUM )
set(CONAN_BUILD_MODULES_PATHS_LIBSODIUM )
# COMPILE_DEFINITIONS are equal to CONAN_DEFINES without -D, for targets
set(CONAN_COMPILE_DEFINITIONS_LIBSODIUM )
...
set(CONAN_LIBS zmqpp-static zmq sodium ${CONAN_LIBS})
set(CONAN_PKG_LIBS zmqpp-static zmq sodium ${CONAN_PKG_LIBS})
set(CONAN_SYSTEM_LIBS rt m pthread ${CONAN_SYSTEM_LIBS})
...
macro(conan_define_targets)
    ...
    set(_CONAN_PKG_LIBS_ZMQPP_DEPENDENCIES "${CONAN_SYSTEM_LIBS_ZMQPP} ${CONAN_FRAMEWORKS_FOUND_ZMQPP} CONAN_PKG::zeromq")
    string(REPLACE " " ";" _CONAN_PKG_LIBS_ZMQPP_DEPENDENCIES "${_CONAN_PKG_LIBS_ZMQPP_DEPENDENCIES}")
    conan_package_library_targets("${CONAN_PKG_LIBS_ZMQPP}" "${CONAN_LIB_DIRS_ZMQPP}"
                                  CONAN_PACKAGE_TARGETS_ZMQPP "${_CONAN_PKG_LIBS_ZMQPP_DEPENDENCIES}"
                                  "" zmqpp)
    set(_CONAN_PKG_LIBS_ZMQPP_DEPENDENCIES_DEBUG "${CONAN_SYSTEM_LIBS_ZMQPP_DEBUG} ${CONAN_FRAMEWORKS_FOUND_ZMQPP_DEBUG} CONAN_PKG::zeromq")
    string(REPLACE " " ";" _CONAN_PKG_LIBS_ZMQPP_DEPENDENCIES_DEBUG "${_CONAN_PKG_LIBS_ZMQPP_DEPENDENCIES_DEBUG}")
    conan_package_library_targets("${CONAN_PKG_LIBS_ZMQPP_DEBUG}" "${CONAN_LIB_DIRS_ZMQPP_DEBUG}"
                                  CONAN_PACKAGE_TARGETS_ZMQPP_DEBUG "${_CONAN_PKG_LIBS_ZMQPP_DEPENDENCIES_DEBUG}"
                                  "debug" zmqpp)
    set(_CONAN_PKG_LIBS_ZMQPP_DEPENDENCIES_RELEASE "${CONAN_SYSTEM_LIBS_ZMQPP_RELEASE} ${CONAN_FRAMEWORKS_FOUND_ZMQPP_RELEASE} CONAN_PKG::zeromq")
    string(REPLACE " " ";" _CONAN_PKG_LIBS_ZMQPP_DEPENDENCIES_RELEASE "${_CONAN_PKG_LIBS_ZMQPP_DEPENDENCIES_RELEASE}")
    conan_package_library_targets("${CONAN_PKG_LIBS_ZMQPP_RELEASE}" "${CONAN_LIB_DIRS_ZMQPP_RELEASE}"
                                  CONAN_PACKAGE_TARGETS_ZMQPP_RELEASE "${_CONAN_PKG_LIBS_ZMQPP_DEPENDENCIES_RELEASE}"
                                  "release" zmqpp)
    set(_CONAN_PKG_LIBS_ZMQPP_DEPENDENCIES_RELWITHDEBINFO "${CONAN_SYSTEM_LIBS_ZMQPP_RELWITHDEBINFO} ${CONAN_FRAMEWORKS_FOUND_ZMQPP_RELWITHDEBINFO} CONAN_PKG::zeromq")
    string(REPLACE " " ";" _CONAN_PKG_LIBS_ZMQPP_DEPENDENCIES_RELWITHDEBINFO "${_CONAN_PKG_LIBS_ZMQPP_DEPENDENCIES_RELWITHDEBINFO}")
    conan_package_library_targets("${CONAN_PKG_LIBS_ZMQPP_RELWITHDEBINFO}" "${CONAN_LIB_DIRS_ZMQPP_RELWITHDEBINFO}"
                                  CONAN_PACKAGE_TARGETS_ZMQPP_RELWITHDEBINFO "${_CONAN_PKG_LIBS_ZMQPP_DEPENDENCIES_RELWITHDEBINFO}"
                                  "relwithdebinfo" zmqpp)
    set(_CONAN_PKG_LIBS_ZMQPP_DEPENDENCIES_MINSIZEREL "${CONAN_SYSTEM_LIBS_ZMQPP_MINSIZEREL} ${CONAN_FRAMEWORKS_FOUND_ZMQPP_MINSIZEREL} CONAN_PKG::zeromq")
    string(REPLACE " " ";" _CONAN_PKG_LIBS_ZMQPP_DEPENDENCIES_MINSIZEREL "${_CONAN_PKG_LIBS_ZMQPP_DEPENDENCIES_MINSIZEREL}")
    conan_package_library_targets("${CONAN_PKG_LIBS_ZMQPP_MINSIZEREL}" "${CONAN_LIB_DIRS_ZMQPP_MINSIZEREL}"
                                  CONAN_PACKAGE_TARGETS_ZMQPP_MINSIZEREL "${_CONAN_PKG_LIBS_ZMQPP_DEPENDENCIES_MINSIZEREL}"
                                  "minsizerel" zmqpp)

    add_library(CONAN_PKG::zmqpp INTERFACE IMPORTED)

    # Property INTERFACE_LINK_FLAGS do not work, necessary to add to INTERFACE_LINK_LIBRARIES
    set_property(TARGET CONAN_PKG::zmqpp PROPERTY INTERFACE_LINK_LIBRARIES ${CONAN_PACKAGE_TARGETS_ZMQPP} ${_CONAN_PKG_LIBS_ZMQPP_DEPENDENCIES}
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,SHARED_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_ZMQPP_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,MODULE_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_ZMQPP_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,EXECUTABLE>:${CONAN_EXE_LINKER_FLAGS_ZMQPP_LIST}>

                                                                 $<$<CONFIG:Release>:${CONAN_PACKAGE_TARGETS_ZMQPP_RELEASE} ${_CONAN_PKG_LIBS_ZMQPP_DEPENDENCIES_RELEASE}
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,SHARED_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_ZMQPP_RELEASE_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,MODULE_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_ZMQPP_RELEASE_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,EXECUTABLE>:${CONAN_EXE_LINKER_FLAGS_ZMQPP_RELEASE_LIST}>>

                                                                 $<$<CONFIG:RelWithDebInfo>:${CONAN_PACKAGE_TARGETS_ZMQPP_RELWITHDEBINFO} ${_CONAN_PKG_LIBS_ZMQPP_DEPENDENCIES_RELWITHDEBINFO}
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,SHARED_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_ZMQPP_RELWITHDEBINFO_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,MODULE_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_ZMQPP_RELWITHDEBINFO_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,EXECUTABLE>:${CONAN_EXE_LINKER_FLAGS_ZMQPP_RELWITHDEBINFO_LIST}>>

                                                                 $<$<CONFIG:MinSizeRel>:${CONAN_PACKAGE_TARGETS_ZMQPP_MINSIZEREL} ${_CONAN_PKG_LIBS_ZMQPP_DEPENDENCIES_MINSIZEREL}
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,SHARED_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_ZMQPP_MINSIZEREL_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,MODULE_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_ZMQPP_MINSIZEREL_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,EXECUTABLE>:${CONAN_EXE_LINKER_FLAGS_ZMQPP_MINSIZEREL_LIST}>>

                                                                 $<$<CONFIG:Debug>:${CONAN_PACKAGE_TARGETS_ZMQPP_DEBUG} ${_CONAN_PKG_LIBS_ZMQPP_DEPENDENCIES_DEBUG}
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,SHARED_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_ZMQPP_DEBUG_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,MODULE_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_ZMQPP_DEBUG_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,EXECUTABLE>:${CONAN_EXE_LINKER_FLAGS_ZMQPP_DEBUG_LIST}>>)
    set_property(TARGET CONAN_PKG::zmqpp PROPERTY INTERFACE_INCLUDE_DIRECTORIES ${CONAN_INCLUDE_DIRS_ZMQPP}
                                                                      $<$<CONFIG:Release>:${CONAN_INCLUDE_DIRS_ZMQPP_RELEASE}>
                                                                      $<$<CONFIG:RelWithDebInfo>:${CONAN_INCLUDE_DIRS_ZMQPP_RELWITHDEBINFO}>
                                                                      $<$<CONFIG:MinSizeRel>:${CONAN_INCLUDE_DIRS_ZMQPP_MINSIZEREL}>
                                                                      $<$<CONFIG:Debug>:${CONAN_INCLUDE_DIRS_ZMQPP_DEBUG}>)
    set_property(TARGET CONAN_PKG::zmqpp PROPERTY INTERFACE_COMPILE_DEFINITIONS ${CONAN_COMPILE_DEFINITIONS_ZMQPP}
                                                                      $<$<CONFIG:Release>:${CONAN_COMPILE_DEFINITIONS_ZMQPP_RELEASE}>
                                                                      $<$<CONFIG:RelWithDebInfo>:${CONAN_COMPILE_DEFINITIONS_ZMQPP_RELWITHDEBINFO}>
                                                                      $<$<CONFIG:MinSizeRel>:${CONAN_COMPILE_DEFINITIONS_ZMQPP_MINSIZEREL}>
                                                                      $<$<CONFIG:Debug>:${CONAN_COMPILE_DEFINITIONS_ZMQPP_DEBUG}>)
    set_property(TARGET CONAN_PKG::zmqpp PROPERTY INTERFACE_COMPILE_OPTIONS ${CONAN_C_FLAGS_ZMQPP_LIST} ${CONAN_CXX_FLAGS_ZMQPP_LIST}
                                                                  $<$<CONFIG:Release>:${CONAN_C_FLAGS_ZMQPP_RELEASE_LIST} ${CONAN_CXX_FLAGS_ZMQPP_RELEASE_LIST}>
